...
export const PRODUTOS: Product[] = [
  ...
  {
    id: "doc-001",
    nome: "Rosquinha com cafe",
    categoria: "doce",
    subcategoria: "Doces",
    descricaoCurta: "Rosquinha servida com cafe em uma combinacao individual.",
    preco: 0,
  ...
  },
  {
    ...
    categoria: "bebida",
    subcategoria: "Bebidas",
    descricaoCurta: "Bebida citrica de perfil tropical para acompanhar o pedido.",
    preco: 0,
  ...
  },
  {
    ...
    categoria: "bebida",
    subcategoria: "Bebidas",
    descricaoCurta: "Opcao cremosa para servir gelada em pedidos individuais.",
    preco: 0,
  ...
  },
  {
    ...
    categoria: "bebida",
    subcategoria: "Bebidas",
    descricaoCurta: "Bebida citrica para servir gelada e refrescante.",
    preco: 0,
  ...
  },
  {
    ...
    descricaoCurta: "Salgado individual servido em embalagem pronta para entrega.",
    preco: 0,
